...
void init_clip_text_model_with_projection(py::module_& m) {
    auto clip_text_model_with_projection =
        py::class_<ov::genai::CLIPTextModelWithProjection>(m,
    ...
    py::class_<ov::genai::CLIPTextModelWithProjection::Config>(
        ...
        .def_readwrite("max_position_embeddings",
                       &ov::genai::CLIPTextModelWithProjection::Config::max_position_embeddings)
        .def_readwrite("num_hidden_layers", &ov::genai::CLIPTextModelWithProjection::Config::num_hidden_layers);

    clip_text_model_with_projection
        .def("reshape", &ov::genai::CLIPTextModelWithProjection::reshape, py::arg("batch_size"))
        .def("infer",
             &ov::genai::CLIPTextModelWithProjection::infer,
             py::arg("pos_prompt"),
             py::arg("neg_prompt"),
             py::arg("do_classifier_free_guidance"))
        ...
        .def(
            "compile",
            [](ov::genai::CLIPTextModelWithProjection& self, const std::string& device, const py::kwargs& kwargs) {
                self.compile(device, pyutils::kwargs_to_any_map(kwargs));
            },
            py::arg("device"),
            "device on which inference will be done",
