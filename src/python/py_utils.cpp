...
ov::Any py_object_to_any(const py::object& py_obj, std::string property_name) {
    ...
    std::set<std::string> size_t_properties = {"max_new_tokens",
                                               "max_length",
                                               "min_new_tokens",
                                               "logprobs",
                                               "num_beam_groups",
...
ov::genai::StreamerVariant pystreamer_to_streamer(const PyBindStreamerVariant& py_streamer) {
    ...
    std::visit(overloaded{[&streamer](const std::function<bool(py::str)>& py_callback) {
...
ov::genai::OptionalGenerationConfig update_config_from_kwargs(const ov::genai::OptionalGenerationConfig& config,
